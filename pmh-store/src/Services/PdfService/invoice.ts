...
export const generateInvoicePdf = (data:any) => {
    ...
    doc.text("Address: Valzhakkili", pageWidth / 2, 28, { align: "center" });
    doc.text("Phone: 434343434", pageWidth / 2, 34, { align: "center" });
    ...
    doc.text(`Customer Mobile: ${data.customerMobile}`, 10, 66);
