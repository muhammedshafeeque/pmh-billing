...
import CreateAndUpdateStock from '../../Components/CreateAndUpdateStock/CreateAndUpdateStock';
      ...
      <Col className="mt-5">
        ...
        <div className="row col-md-12">
          ...
          <div className="col-md-2">
            <Button onClick={handleModal}>Add New Stock</Button>
          </div>
        </div>
        <ModalComponent show={modal} popup_head="Create Stock">
          <CreateAndUpdateStock onHide={() => handleModal()}/>      
        </ModalComponent>
